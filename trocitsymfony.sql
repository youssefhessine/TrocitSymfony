...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 03 mai 2023 à 23:31
...
INSERT INTO `club` (`id`, `nom_pub`, `description`, `image`, `id_communaute_id`) VALUES
(11, 'dataSience IT', 'Data Sience DS', '6ba20e58bcedb856323ca70d53ad8d21.jpg', 9),
(12, 'Trocit', 'Groups Trocit', '97270fab8a30ba2e397c2291631ee6c7.png', 8),
(13, 'Elyadata', 'dataSience IA', 'b12e86943f9042c1907763bad92b4d5b.jpg', 9);
...
INSERT INTO `communaute` (`id`, `nom`, `adresse`, `email`, `num_tel`) VALUES
(8, 'dev', 'medenine', 'yassin.saoud@esprit.tn', 23556678),
(9, 'dataSience IT', 'medenine', 'iheb.zaidi@esprit.tn', 52107756);
...
(65, 'AZLEJLJRERKRE', 'test', 'zzfnofnzkfze', '2018-01-01', 12, '8d27d17f46cf1c5f6be5c8370f7b42a5.png', 34);
...
INSERT INTO `rating` (`id`, `rate`, `iduser`, `idcom`) VALUES
(57, 5, 1, 12);
...
--
ALTER TABLE `club`
  ADD CONSTRAINT `club_ibfk_1` FOREIGN KEY (`id_communaute_id`) REFERENCES `communaute` (`id`);

--
-- Contraintes pour la table `don`
--
ALTER TABLE `don`
  ADD CONSTRAINT `don_ibfk_1` FOREIGN KEY (`id_association`) REFERENCES `association` (`id`);

--
-- Contraintes pour la table `rating`
--
ALTER TABLE `rating`
  ADD CONSTRAINT `rating_ibfk_1` FOREIGN KEY (`iduser`) REFERENCES `utilisateur` (`id`),
  ADD CONSTRAINT `rating_ibfk_2` FOREIGN KEY (`idcom`) REFERENCES `club` (`id`);
COMMIT;
