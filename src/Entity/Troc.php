 ...
 * Troc
 *
 * @ORM\Table(name="troc", indexes={@ORM\Index(name="produit1ref_2", columns={"produit1ref", "produit2ref"}), @ORM\Index(name="produit1ref", columns={"produit1ref", "produit2ref"}), @ORM\Index(name="offre_troc1", columns={"produit2ref"}), @ORM\Index(name="IDX_A4B213638E22C9EA", columns={"produit1ref"})})
 * @ORM\Entity
 */
class Troc
{
